...
public class Launcher {
	...
	public static void testDungeon() {
		...
		Room r1 = new Room("Start", "You are in a large courtyard enclosed by grey stone walls engulfed in rose bushes."
									...
									+ " A lonely door blocks your path north.");
		r1.eventFirstTime = "The gate clatters shut behind.";
		Room r2 = new Room("r2", "Can go south, north and east.");
		Room r3 = new Room("r3", "Can go west and north.");
		Room r4 = new Room("r4", "Can go south and west.");
		Room r5 = new Room("r5", "Can go south and east.");
